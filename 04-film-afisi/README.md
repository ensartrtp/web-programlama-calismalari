...
## 🚀 Kullanım
1. "Film Bilgileri" bölümündeki alanları doldurun:
   - 📌 Film Adı
   - ⭐ IMDB Puanı
   - 🖼️ Afiş URL'si
   - 📝 Film Açıklaması

2. "Kartı Güncelle" butonuna tıklayın veya Enter tuşuna basın.
3. Oluşturulan film kartını sağ tarafta görüntüleyin.

### **Düzenleme Özellikleri**
- **Çift Tıklama**: Çıktı alanındaki herhangi bir metne çift tıklayarak düzenleyin.
- **Anlık Güncelleme**: Input alanlarına yazdıkça çıktı anlık güncellenir.
- **Otomatik Sıfırlama**: Güncelleme sonrası form alanları temizlenir.

## ⚠️ Notlar ve İpuçları

-  IMDB puanı için sadece sayı girişi yapılmalıdır.
